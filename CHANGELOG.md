...
- `media/compare-years.mp4` re-taken for the same trend-strip fix, and recut: it had opened on the Simulator's Home screen and the app-icon launch zoom, because the recording's own first frame was the previous take's white screen and the launch detector matched that instead (22.1 s, was 19.4 s)
